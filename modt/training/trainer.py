...
class Trainer:
    ...
    def train_iteration(self, ep):
        ...
        (
            set_final_return,
            set_unweighted_raw_return,
            set_weighted_raw_return,
            set_cum_r_original,
        ) = [], [], [], []
        for eval_fn in self.eval_fns:
            (
                outputs,
                final_returns,
                unweighted_raw_returns,
                weighted_raw_returns,
                cum_r_original,
            ) = eval_fn(self.model, cur_step)
        ...
        target_returns = np.array(
            [eval_fn.target_reward for eval_fn in self.eval_fns]
        )  # target returns are weighted
